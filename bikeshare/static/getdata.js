var mytable = document.getElementById("tbl");//keep adding to end of this element
var clearbtn = window.parent.document.getElementById("clearbtn");
var morebtn = window.parent.document.getElementById("morebtn");
